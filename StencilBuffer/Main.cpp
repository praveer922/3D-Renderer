...
int main()
{
    ...
    // -------------------------
    Shader shader("framebuffer_vs.txt", "framebuffer_fs.txt");
    Shader screenShader("screen_vs.txt", "screen_fs.txt");
    Shader skyboxShader("skybox_vs.txt", "skybox_fs.txt");
    Shader floorShader("floor_vs.txt", "floor_fs.txt");
